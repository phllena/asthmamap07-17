...
shinyUI(navbarPage(id="nav",
                   ...
                   tabPanel("BRFSS Asthma Data 2007-2017","BRFSS Asthma Data 2007-2017",
                            div(class="outer",
                                tags$head(
                                ...
                                absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                              ...
                                              selectInput("var", label = "Year:", choices = c(as.character(c("2007":"2017")),"2007-2017 (all years)"),
                                                          selected = "2007-2017 (all years)", width="100%"),
                                              br(),
