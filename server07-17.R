...
current.asthma.2013 = filter(weighted_current_asthma_prev, YEAR == 2013)
current.asthma.2014 = filter(weighted_current_asthma_prev, YEAR == 2014)
current.asthma.2015 = filter(weighted_current_asthma_prev, YEAR == 2015)
current.asthma.2016 = filter(weighted_current_asthma_prev, YEAR == 2016)
current.asthma.2017 = filter(weighted_current_asthma_prev, YEAR == 2017)
...
asthma_prev_data <- list(current.asthma.2007, current.asthma.2008, current.asthma.2009,
                         current.asthma.2010, current.asthma.2011, current.asthma.2012, 
                         current.asthma.2013, current.asthma.2014, current.asthma.2015,
                         current.asthma.2016, current.asthma.2017, current.asthma.all)
...
current.vars.2013 = filter(weighted_current_vars, YEAR == 2013)
current.vars.2014 = filter(weighted_current_vars, YEAR == 2014)
current.vars.2015 = filter(weighted_current_vars, YEAR == 2015)
current.vars.2016 = filter(weighted_current_vars, YEAR == 2016)
current.vars.2017 = filter(weighted_current_vars, YEAR == 2017)
...
vars_data <- list(current.vars.2007, current.vars.2008, current.vars.2009,
                  current.vars.2010, current.vars.2011, current.vars.2012,
                  current.vars.2013, current.vars.2014, current.vars.2015,
                  current.vars.2016, current.vars.2017, current.vars.all)
  ...
  function(input, output, session) {
    ...
    brfss_year <- reactive({
      switch(input$var,
             ...
             "2013" = asthma_prev_data[[7]],
             "2014" = asthma_prev_data[[8]],
             "2015" = asthma_prev_data[[9]],
             "2016" = asthma_prev_data[[10]],
             "2017" = asthma_prev_data[[11]],
             "2007-2017 (all years)" = asthma_prev_data[[12]]
      )
    })
    ...
    full_dat <- reactive({
      switch(input$var,
             ...
             "2016" = vars_data[[10]],
             "2017" = vars_data[[11]],
             "2007-2017 (all years)" = vars_data[[12]]
      )
    })
